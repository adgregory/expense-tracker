...
Create `.env`:
```
DATABASE_URL="postgresql://neondb_owner:npg_eQkKJjI1T8vc@ep-shy-mud-apa99ab3.c-7.us-east-1.aws.neon.tech/neondb?sslmode=require"
API_KEY="expense-tracker-ios-key-2026"
```
...
curl -X POST http://localhost:3000/api/sms \
  ...
  -H "x-api-key: expense-tracker-ios-key-2026" \
